...
create table if not exists public.operators (
  ...
  admin_labos  uuid[] default null,                 -- NULL/{} = admin principal ; sinon labos autorisés
  actif        boolean default true,
  token        text,
...
-- admin_labos NULL/{} = admin principal ; sinon appartenance explicite.
...
returns boolean language sql immutable as $$
  select (r.is_admin is true
      ...
      or (r.is_admin is not true and r.labo_id is not null and l.labo_id = r.labo_id);
$$;
